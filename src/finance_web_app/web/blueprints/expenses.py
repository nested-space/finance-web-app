...
from finance_web_app.core.runtime.container import get_expense_service
...
def _current_month_context() -> dict[str, object]:
    today = date.today()
    return expenses_page_context(get_expense_service().list_effective(today.year, today.month))
