...
- **C3b — Per-page charts.** Budgets page (spend-vs-budget bar, breakdown pie, 6-month history) and expenses page (category-filterable line + `/finance/api/expenses`, breakdown pie, 6-month history).
